    ...
    <aside className="w-16 bg-white border-r border-slate-200 flex flex-col items-center py-4 justify-between select-none z-20 shrink-0">
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        >
          ...
          <span className="text-[9px] font-bold tracking-wider text-slate-700 mt-1">EDUMIND</span>
        </button>
        ...
        <nav className="flex flex-col items-center gap-2">
          ...
          <button
            ...
            onClick={openAiChat}
            className="w-10 h-10 rounded-lg flex flex-col items-center justify-center bg-slate-50 text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 hover:border-emerald-200 transition-all border border-slate-200 shadow-2xs group mt-1"
            title="Hỏi AI Gen Z ✨"
          >
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <button 
          ...
          className="w-9 h-9 rounded-full overflow-hidden border border-slate-200 hover:ring-2 hover:ring-slate-300 transition-all"
        >
          <img
